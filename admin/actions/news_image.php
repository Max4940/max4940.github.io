...
if($_FILES['upload_image']['type'] == 'image/jpeg' || $_FILES['upload_image']['type'] == 'image/jpg' || $_FILES['upload_image']['type'] == 'image/png' || $_FILES['upload_image']['type'] == 'image/svg')
{ 
...
{
 $error_img[] =  'Допустимые расширения: jpeg, jpg, png, svg';
}
}
?>